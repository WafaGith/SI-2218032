                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive text-nowrap">
                                <a href="{{ route('create-penumpang') }}" class="btn btn-success"
                                    style="margin:0px 20px 0px 25px">Tambah Data</a>
                                <a href="{{ route('pdf-penumpang') }}" class="btn btn-danger">Cetak PDF</a>
                                <table class="table table-striped">
                                    ...
                                    @foreach ($tb_penumpang as $p)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-penumpang', ['id' => $p->id]) }}"class="btn btn-primary">Edit</a>
                                                <a href="{{ route('delete-penumpang', ['id' => $p->id]) }}"class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
